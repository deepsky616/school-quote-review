        ...
        {mode === "browser" && (
          <div className="import-panel" role="tabpanel">
            <div className="optional-card">
              <div className="optional-label">정확도 향상 · 선택 기능</div>
              <h3>구조화 상품 데이터를 먼저 읽습니다</h3>
              <p>도우미는 상품명·수량·가격이 이미 나뉜 데이터(L2)를 먼저 찾고, 없을 때만 화면 구조(L3)를 읽습니다. 최초 한 번만 설치하며 복사·붙여넣기와 PDF 방법은 그대로 사용할 수 있습니다.</p>
              ...
              <div className="browser-actions">
                <a className="helper-download" href="./edufine-helper-0.2.0.zip" download>개선된 도우미 받기</a>
